...
@section('content')
    ...
    <section class="team-section ptb-120">
        <div class="container service-checkout-cls">
            <h1>{{$pageTitle}}</h1>
            <form id="custom-checkout-form" action="{{ route('file.pass.process.payment') }}" method="post">
                @csrf
                <div class="row justify-content-center pb-30">
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-12 col-12 payment-cls">
                        <div class='bg--base rounded text-white p-4 font-14'>
                            <div class="row mb-2">
                                <div class="col-lg-8 col-md-8 col-7">
                                    <label class="pay-side-main-label">Upto <span id="fileSize"></span> Transfer</label>
                                </div>

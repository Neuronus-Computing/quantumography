...
<body>
    ...
    <section class="team-section ptb-70">
        <div class="last-padd">
            <h4 style="font-style: italic;margin-bottom: 0px;font-size: 18px;">Dear {{$emailData["user"]->name}}!</h4>
            <p style="margin-bottom:20px;font-size: 16px;">
                Thank you for choosing <a href="{{ env('APP_URL') }}" class="default-text-color"><strong>  Neuronus.net</strong></a>! Your order <strong> {{$emailData['payment_details']->order_no}} </strong> is being processed.

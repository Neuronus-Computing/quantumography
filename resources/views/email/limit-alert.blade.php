                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td style="padding-bottom: 10px; padding-left: 20px; padding-right: 20px;"
                                                        ...
                                                        <h4 class="text"
                                                            ...
                                                            Your API requests are near to the end, more than 75% of your {{$emailData['api']}} API requests are used.</h4>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td style="padding-bottom: 10px; padding-left: 20px; padding-right: 20px;"
                                                ...
                                                <tr>
                                                    <td style="padding-bottom: 10px; padding-left: 20px; padding-right: 20px;"
                                                        ...
                                                        <h5 class="text"
                                                            style="color:#999;font-family:Poppins,Helvetica,Arial,sans-serif;font-size:16px;font-weight:500;font-style:normal;letter-spacing:normal;line-height:24px;text-transform:none;padding:0;margin:0">
                                                            Total Requests: {{ $emailData['limit'] }}</h5>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td style="padding-bottom: 10px; padding-left: 20px; padding-right: 20px;"
                                                        ...
                                                        <h5 class="text"
                                                            style="color:#999;font-family:Poppins,Helvetica,Arial,sans-serif;font-size:16px;font-weight:500;font-style:normal;letter-spacing:normal;line-height:24px;text-transform:none;padding:0;margin:0">
                                                            Used Requests: {{ $emailData['limit'] - $emailData['remaining'] }}</h5>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td style="padding-bottom: 10px; padding-left: 20px; padding-right: 20px;"
                                                        ...
                                                        <h5 class="text"
                                                            style="color:#999;font-family:Poppins,Helvetica,Arial,sans-serif;font-size:16px;font-weight:500;font-style:normal;letter-spacing:normal;line-height:24px;text-transform:none;padding:0;margin:0">
                                                            Remaining Requests: {{ $emailData['remaining'] }}</h5>
                                                    </td>
                                                </tr>
